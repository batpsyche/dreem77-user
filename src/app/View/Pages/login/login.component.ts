...
export class LoginComponent implements OnInit {
  ...
  checkMaintenanceSetting() {
    this.loginservice.checkMaintenanceSetting().subscribe(
      (response) => {
  ...
  globalConstant() {
    this.loginservice.globalConstant().subscribe(
      (response) => {
        this.is_show_apk = response.data.ApkData.is_active;
        this.super_admin_commission_type =
          response.data.super_admin_commission_type;
        this.mobile = response.data.phone_no;
        this.phone_no =
          response.data.country_code + " " + response.data.phone_no;
        this.global.super_admin_commission_type =
          this.super_admin_commission_type;
  ...
  onSubmit() {
    ...
    this.loginservice.submitUser(this.userData).subscribe(
      (result) => {
        if (!result.error) {
