...
import { SA_GAMES } from 'src/app/GAME-LISTS/sa.games';
import { MegaWinGameService } from 'src/app/Service/MegaWin/mega-win.service';

@Component({
  selector: 'app-sa-games',
  templateUrl: './sa-games.component.html',
  styleUrls: ['./sa-games.component.scss']
})
export class SaGamesComponent implements OnInit {
  SAGAMES = SA_GAMES;
  private userDetails;
