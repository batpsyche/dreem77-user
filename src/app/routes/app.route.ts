...
const routes: Routes = [
    ...
    { path: 'UnderMaintinance', component: UnderMaintinanceComponent },
    {
        ...
        loadChildren: 'src/app/View/layout/dashboard/dashboard.module#DashboardModule',
        component: DashboardComponent,
    },
    {
        path: 'subdashboard',
        canActivate: [AuthGuard],
        loadChildren: 'src/app/View/layout/subdashboard/subdashboard.module#SubdashboardModule',
